...
export function createHighestBidIncreaseEvent(
  bidder: Address,
  amount: BigInt
): HighestBidIncrease {
  let highestBidIncreaseEvent = changetype<HighestBidIncrease>(newMockEvent())

  highestBidIncreaseEvent.parameters = new Array()

  highestBidIncreaseEvent.parameters.push(
  ...
  return highestBidIncreaseEvent
}
